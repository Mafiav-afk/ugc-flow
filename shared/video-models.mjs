...
export function videoSelectionParams(model, selection = {}, profileOverride = '') {
  ...
  if (/sora/i.test(id)) return { duration: normalized.duration, seconds: normalized.duration, size: normalized.resolution, aspect_ratio: normalized.aspectRatio, orientation: normalized.aspectRatio === '9:16' ? 'portrait' : 'landscape' }
